...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post hospitals_url, params: { hospital: { address: @hospital.address, name: @hospital.name, phone: @hospital.phone, website: @hospital.website } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { address: @hospital.address, name: @hospital.name, phone: @hospital.phone, website: @hospital.website } }
